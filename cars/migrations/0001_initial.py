    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_image1', models.ImageField(blank=True, upload_to='photos/%Y/%M/%D/')),
                ('car_image2', models.ImageField(blank=True, upload_to='photos/%Y/%M/%D/')),
                ('car_image3', models.ImageField(blank=True, upload_to='photos/%Y/%M/%D/')),
                ('car_image4', models.ImageField(blank=True, upload_to='photos/%Y/%M/%D/')),
